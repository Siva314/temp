...
public interface StorageLayer {
	...
	String getUserStatus(int userId) throws HelperException;
	...
	Map<Long,AccountInfo> getAccountDetails(UserInfo user,String status) throws HelperException;
	...
	List<TransactionInfo> getAllTransactionDetailsWithDate(long accountNumber,int days)throws HelperException;
